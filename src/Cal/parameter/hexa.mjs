...
// 編號；維度類型；數字；true可能是阴阳卦。類型有五個數字，是五個維度，分別表示：
// -	主要阳数：1一，2七，3未知；
// -	形式：1六爻单卦，2六爻对卦，3三爻，4四爻，5未知；
// -	地域：1殷墟，2周地，3楚，4其他；
// -	时代：1晚商早周，2西周中晚期，3春秋，4战国，5其他；
// -	材质：1甲，2骨，3铜、陶范，4陶器，5石，6简册；
const HexoZhouList = {
  1001: ["13453", "161"],
  2002: ["35111", "666!"], // 贾排除
  3003: ["24111", "6776"],
...
// const keys = Object.keys(HexoChuList).map((key) => parseInt(key));
...
const ZhuxiBianList = [
  5.960464478, 3.576278687, 2.145767212, 1.287460327, 0.7724761963, 4634857178,
  0.2780914307
]; // 朱熹筮法各类變卦概率%
...
// 1楚
const ListN1C = [
  62111, 64113, 65114, 66115, 67116, 68117, 69118, 71120, 72121, 73122, 73123,
  74124, 75125, 76126, 77127, 78128, 79129, 80130, 81131, 82132, 83133, 84134,
  85135, 86136, 87137, 88138
];
// 1周=11210
const ListN1Z = [
...
const ListN7Yc = [19030, 19031, 20032, 20033]; // 21113
const ListN7Y = [
...
// 1晚-甲骨=11021
const ListN1Ma = [52073, 52074, 52075, 52076, 52077, 52078, 52079]; 
// 1晚-陶=11023
const ListN1Mc = [
...
const ListNThree = [
  1001, 5007, 7012, 9017, 10018, 11019, 12020, 37057, 39059, 46066, 50071, 51072
]; // 三爻卦
...
// console.log(Count(HexoChuList, [ListN1C]));
