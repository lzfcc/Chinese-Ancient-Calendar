...
const ListN1YZS = [7011, 10018, 16025, 17027, 22035, 24042, 24043, 39059, 50071]; // 10010, true
const ListN7YZS = [
...
const ListP1MS = [0, 13.3333, 16.6667, 40.0, 20.0, 10.0, 60];
const ListP7M = [0, 6.6667, 36.6667, 26.6667, 30.0, 0, 30];
const ListPDuo = [0, 8.3333, 35.6061, 38.6364, 15.9091, 1.5152, 132];
const ListP1YZS = [0, 22.2222, 22.2222, 44.4444, 11.1111, 0, 45];
const ListP7YZS = [0, 16.25, 31.25, 33.75, 15.0, 3.75, 80];
export const ListPAll = [
  [0, 4.6296, 38.8889, 37.963, 15.7407, 2.7778, 108],
  [0, 13.3333, 16.6667, 40.0, 20.0, 10.0, 60],
  [0, 22.2222, 22.2222, 44.4444, 11.1111, 0, 45],
  [0, 16.25, 31.25, 33.75, 15.0, 3.75, 80],
];

// console.log(Sigma3(ListPXIII.slice(0, 6)));
// 分系
...
// console.log(Devide(HexoZhouList, "11020"));
// 各分系的概率
...
// console.log(Count(HexoZhouList, [52073, 52074, 52075, 52076, 52077, 52078, 52079, 57088, 57089, 57090, 57091, 57092, 57093, 57094, 57095, 57096, 57097, 57098, 58099, 58100, 58101, 61110]));
