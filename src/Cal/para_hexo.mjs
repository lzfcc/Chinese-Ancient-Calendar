...
export const ListNXII = [
  7011, 10018, 16025, 17027, 22035, 24042, 24043, 39059, 50071,
]; // 10010, true
export const ListNXIII = [
...
export const ListPXIII = [0, 16.25, 31.25, 33.75, 15.0, 3.75, 80];
...
// console.log(Devide(HexoZhouList, "20010", true));
...
// console.log(Count(HexoZhouList, [ListNXIII]));
