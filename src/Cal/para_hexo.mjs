...
const stdAFake = [.21, 5.01, 34.74, 41.24, 16.68, 2.12]; // 四—九的贾连翔朴素理论值
...
const ZhuxiBianList = [
  5.960464478, 3.576278687, 2.145767212, 1.287460327, .7724761963,
  4634857178, .2780914307,
]; // 朱熹筮法各类變卦概率%
...
const ListN7Za = [6008, 6009, 6010, 27047, 28048, 29049, 31051, 32052]; // 21211
const ListN7Zb = [33053, 34054, 35055, 40060, 43063, 49070]; // 21212
const ListN7Zc = [23036, 23037, 23038, 23041]; // 21213
...
export const ListPSheleAll = [
  ...
  [
    [.96, 10.28, 36.45, 42.59, 9.17, .56],
    [.96, 10.28, 36.45, 42.58, 9.17, .56],
    [.96, 10.28, 36.45, 42.58, 9.16, .56],
    [.97, 10.33, 36.53, 42.48, 9.13, .56],
    [.97, 10.33, 36.53, 42.48, 9.13, .56],
    [.96, 10.26, 36.28, 42.41, 9.49, .6],
    [1.0, 10.62, 36.98, 41.54, 9.22, .64],
    [.99, 10.56, 36.67, 41.42, 9.72, .64],
    [.95, 10.27, 36.45, 41.99, 9.7, .64],
    [1.01, 10.38, 35.9, 42.42, 9.69, .59],
    [1.01, 10.38, 35.87, 42.26, 9.85, .62],
    [.91, 9.76, 35.98, 42.48, 10.17, .71],
    [.96, 9.81, 34.99, 43.28, 10.17, .8],
  ],
  [
    [.71, 10.15, 42.94, 35.26, 10.0, .94],
    [.71, 10.15, 42.95, 35.26, 10.0, .94],
    [.71, 10.15, 42.94, 35.26, 10.0, .94],
    [.72, 10.26, 43.3, 34.98, 9.83, .91],
    [.71, 10.22, 43.12, 34.9, 10.07, .97],
    [.7, 10.04, 42.79, 35.28, 10.15, 1.04],
    [.69, 10.04, 42.74, 35.02, 10.49, 1.01],
    [.74, 10.28, 42.47, 34.94, 10.56, 1.01],
    [.72, 10.04, 42.13, 35.5, 10.58, 1.02],
    [.7, 9.83, 41.7, 35.89, 10.78, 1.1],
    [.71, 9.94, 41.48, 36.11, 10.66, 1.09],
    [.69, 10.14, 40.42, 35.98, 11.5, 1.27],
    [.76, 10.46, 40.23, 35.85, 11.41, 1.29],
  ],
  [
    [.44, 6.63, 31.93, 43.87, 15.5, 1.64],
    [.44, 6.63, 31.93, 43.87, 15.5, 1.64],
    [.44, 6.65, 32.01, 43.8, 15.46, 1.63],
    [.44, 6.65, 32.01, 43.81, 15.46, 1.63],
    [.46, 6.89, 32.67, 42.91, 15.39, 1.67],
    [.44, 6.75, 32.36, 43.19, 15.47, 1.8],
    [.43, 6.62, 31.89, 43.16, 16.12, 1.78],
    [.46, 6.8, 31.85, 43.01, 16.12, 1.75],
    [.43, 6.41, 30.89, 43.84, 16.6, 1.83],
    [.43, 6.37, 31.15, 43.72, 16.44, 1.89],
    [.4, 6.04, 29.71, 44.99, 16.89, 1.97],
    [.4, 6.39, 29.71, 43.9, 17.44, 2.15],
    [.47, 6.97, 30.92, 42.87, 16.65, 2.12],
  ],
];
const IsOneSix = (str) => {
...
// console.log(Typology(HexoZhouList, "21213", 0));
// 各分系的概率
...
// console.log(Count(HexoZhouList, [ListN7Zc]));
