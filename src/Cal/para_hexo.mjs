...
export const ListPAll = [
  ...
  [0, 11.67, 30.0, 46.67, 11.67, 0, 60],
  [0, 5.81, 42.58, 35.48, 14.84, 1.29, 155],
  [0, 10.84, 38.55, 34.94, 13.25, 2.41, 83],
  [0, 7.02, 21.05, 42.11, 24.56, 5.26, 114],
  [0, 8.3333, 35.6061, 38.6364, 15.9091, 1.5152, 132],
];

// 1CS, 1YZS1, 7YZS1, 7YZS2, 1MS1, Duo
const IsOneSix = (str) => {
