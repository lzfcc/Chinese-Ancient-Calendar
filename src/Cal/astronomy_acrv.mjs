...
export const SunDifAccumTable = (WinsolsDif, CalName) => {
    ...
    SunDifAccumList[0], SunDifAccumList[24] = 0
...
export const SunFormula = (WinsolsDif, CalName) => {
    ...
    let SunDifAccum, Smallquadrant, ExconT = 0
    let signA = 1
    if (Type === 11) {
...
export const AutoTcorr = (AnomaAccum, WinsolsDifRaw, CalName, NodeAccum, year) => {
    ...
    let SunTcorr2, SunTcorr1, MoonTcorr2, MoonTcorr1, Tcorr2, Tcorr1, NodeAccumCorr, NodeAccumCorr2, SunDifAccum, MoonDifAccum = 0
...
export const AutoDifAccum = (AnomaAccum, WinsolsDif, CalName, year) => {
    ...
    AnomaAccum %= Anoma
    let DifAccumFunc = {}
    let SunDifAccum, MoonDifAccum = 0
