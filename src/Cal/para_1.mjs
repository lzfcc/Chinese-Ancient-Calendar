export default {
    ...
    Daye: { // 隋志的大業曆就是修改之後的，冬至起虛七。開元占經寫成了張曹玄
        ...
        SunAcrAvgDifList: [0, 70, 35, 35, 20, 30, 35, -55, -45, -40, -30, -55, -65, -55, -40, -25, -5, -30, -40, 60, 55, 50, 45, 40, 10], // 入氣盈縮。我改變了後半部分正負。以日法為單位，月離表是以章為單位
    ...
    Wuyin: { // 崔善爲修改的戊寅曆未改動傅仁均原始數據，《中國古代曆法》第460頁
        ...
        SunAcrAvgDifList: [0, 896, 398, 400, 228, 341, 450, -500, -455, -355, -555, -848, -739, -626, -456, -288, -40, -342, -455, 682, 625, 570, 513, 456, 100],
        MoonLatiDifList: [0, 16, 15, 14, 12, 9, 5, 1, -2, -6, -10, -13, -15, -16, -(16 + 3188 / 6395)], // 大明陰陽曆
