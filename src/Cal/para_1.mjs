export default {
    ...
    Taichu: {
        ...
        NightList: [0, 27.5, 27.375, 26.875, 25.90625, 24.875, 23.453125, 22.375, 20.953125, 19.921875, 18.9375, 18.359375, 17.859375, 17.5, 17.890625, 18.375, 18.953125, 19.96875, 21.375, 22.46875, 23.90625, 24.953125, 25.96875, 26.890625, 27.421875, 27.5],
        DialList: [0, 13, 12.3, 11, 9.6, 7.95, 6.5, 5.25, 4.15, 3.2, 2.52, 1.98, 1.68, 1.5, 1.7, 2, 2.55, 3.33, 4.35, 5.5, 6.85, 8.4, 10, 11.4, 12.56, 13], // 以四分補之
        SunLatiList: [0, 115, 113 + 1 / 12, 110 + 8 / 12, 106 + 2 / 12, 101 + 1 / 12, 95 + 1 / 12, 89 + 1 / 12, 83 + 2 / 12, 77 + 10 / 12, 73 + 2 / 12, 69 + 8 / 12, 67 + 2 / 12, 67 + 1 / 12, 67 + 10 / 12, 70, 73 + 7 / 12, 78 + 7 / 12, 84 + 4 / 12, 90 + 7 / 12, 96 + 10 / 12, 102 + 4 / 12, 107 + 4 / 12, 110 + 11 / 12, 113 + 10 / 12, 115], // 四分
    },
    Qianzaodu: {
        Denom: 81,
        Lunar: 2392 / 81,
    ...
    EastHan: {
        ...
        MansionFractPosition: 8,
        // DayLight: [0, 45, 45 + 8 / 32, 46 + 8 / 32, 48 + 6 / 32, 50 + 8 / 32, 53 + 3 / 32, 55 + 8 / 32, 58 + 3 / 32, 60 + 5 / 32, 62 + 4 / 32, 63 + 9 / 32, 64 + 9 / 32, 65, 64 + 7 / 32, 63 + 8 / 32, 62 + 3 / 32, 60 + 2 / 32, 57 + 8 / 32, 55 + 2 / 32, 52 + 6 / 32, 50 + 3 / 32, 48 + 2 / 32, 46 + 7 / 32, 45 + 5 / 32], // 四分、乾象、景初。正光興和沒有漏刻
        NightList: [0, 27.5, 27.375, 26.875, 25.90625, 24.875, 23.453125, 22.375, 20.953125, 19.921875, 18.9375, 18.359375, 17.859375, 17.5, 17.890625, 18.375, 18.953125, 19.96875, 21.375, 22.46875, 23.90625, 24.953125, 25.96875, 26.890625, 27.421875, 27.5], // 夜半漏
        DialList: [0, 13, 12.3, 11, 9.6, 7.95, 6.5, 5.25, 4.15, 3.2, 2.52, 1.98, 1.68, 1.5, 1.7, 2, 2.55, 3.33, 4.35, 5.5, 6.85, 8.4, 10, 11.4, 12.56, 13], // 節氣晷長
        SunLatiList: [0, 115, 113 + 1 / 12, 110 + 8 / 12, 106 + 2 / 12, 101 + 1 / 12, 95 + 1 / 12, 89 + 1 / 12, 83 + 2 / 12, 77 + 10 / 12, 73 + 2 / 12, 69 + 8 / 12, 67 + 2 / 12, 67 + 1 / 12, 67 + 10 / 12, 70, 73 + 7 / 12, 78 + 7 / 12, 84 + 4 / 12, 90 + 7 / 12, 96 + 10 / 12, 102 + 4 / 12, 107 + 4 / 12, 110 + 11 / 12, 113 + 10 / 12, 115], // 太陽去極度。111弱我暫時處理成110+11/12。106少強改成少弱
    },
    ...
    Qianxiang: {
        ...
        MoonAcrVRaw: [276, 275, 273, 270, 266, 262, 258, 254, 250, 246, 243, 239, 236, 234, 233, 234, 236, 239, 243, 246, 250, 254, 258, 262, 266, 270, 273, 275 + (4093 + 202 / 1101) / 5969, 276],
        MoonLatiDifList: [0, 17, 16, 15, 12, 8, 4, 1, -2, -6, -10, -13, -15, -16, -(16 + 306 / 473)], // 乾象陰陽曆。/12爲度
    ...
    Huangchu: { // 開元占經。「太史丞韓詡以為乾象減斗分太過，後當先天，造黃初曆」看開元占經的斗分，確實比乾象大。
        ...
        AnomaNumer: 332831, // 
        MoonAcrVRaw: [276, 275, 273, 270, 266, 262, 258, 254, 250, 246, 243, 239, 236, 234, 233, 234, 236, 239, 243, 246, 250, 254, 258, 262, 266, 270, 273, 275 + (4093 + 202 / 1101) / 5969, 276], // 闕，以乾象補之「今韓翊所造皆用洪法，小益斗下分，所錯無幾。」
        OriginAd: 220 - 31578, // 開元占經有問題，以景初為準移之+ 722。《疇人傳》「上元壬午至黃初元年庚子，積三萬一千五百七十八算外」
        ...
        ZhangRange: 19,
        ZhangLeap: 7,
        AnomaOrigin: 220000, // 闕，據紀差77194、以景初為準補之
        // FirstCorr: -8.2,
    ...
    Jingchu: {
        ...
        YinyangOrigin: -1,
        MoonAcrVRaw: [280, 277, 274, 271, 267, 261, 254, 248, 244, 241, 239, 236, 233, 231, 233, 235, 237, 240, 243, 246, 250, 254, 259, 265, 271, 277, 278, 279 + 626 / 86621, 280],
        MoonLatiDifList: [0, 17, 16, 15, 12, 8, 4, 1, -2, -6, -10, -13, -15, -16, -(16 + 306 / 473)], // 乾象陰陽曆
        ...
        NightList: [0, 27.5, 27.375, 26.875, 25.90625, 24.875, 23.453125, 22.375, 20.953125, 19.921875, 18.9375, 18.359375, 17.859375, 17.5, 17.890625, 18.375, 18.953125, 19.96875, 21.375, 22.46875, 23.90625, 24.953125, 25.96875, 26.890625, 27.421875, 27.5],
        DialList: [0, 13, 12.3, 11, 9.6, 7.95, 6.5, 5.25, 4.15, 3.2, 2.52, 1.98, 1.68, 1.5, 1.7, 2, 2.55, 3.33, 4.35, 5.5, 6.85, 8.4, 10, 11.4, 12.56, 13], // 以四分補之
        SunLatiList: [0, 115, 113 + 1 / 12, 110 + 8 / 12, 106 + 2 / 12, 101 + 1 / 12, 95 + 1 / 12, 89 + 1 / 12, 83 + 2 / 12, 77 + 10 / 12, 73 + 2 / 12, 69 + 8 / 12, 67 + 2 / 12, 67 + 1 / 12, 67 + 10 / 12, 70, 73 + 7 / 12, 78 + 7 / 12, 84 + 4 / 12, 90 + 7 / 12, 96 + 10 / 12, 102 + 4 / 12, 107 + 4 / 12, 110 + 11 / 12, 113 + 10 / 12, 115], // 景初同四分
    },
    Liuzhi: { // 晉志下、開元占經。武帝侍中平原劉智，以斗曆改憲，推四分法，三百年而減一日，以百五十爲度法，三十七爲斗分。推甲子爲上元，至泰始十年，歲在甲午，九萬七千四百一十一歲，上元天正甲子朔夜半冬至，日月五星始于星紀，得元首之端。飾以浮說，名爲正曆。
        ...
        MoonAcrVRaw: [280, 277, 274, 271, 267, 261, 254, 248, 244, 241, 239, 236, 233, 231, 233, 235, 237, 240, 243, 246, 250, 254, 259, 265, 271, 277, 278, 279 + 626 / 86621, 280], // 闕，以景初補之
    ...
    Xuanshi: { // 開元占經卷105、疇人傳卷第六
        ...
        MoonAcrVRaw: [(14 + 361 / 505), (14 + 300 / 505), (14 + 236 / 505), (14 + 171 / 505), (14 + 99 / 505), (13 + 471 / 505), (13 + 266 / 505), (13 + 61 / 505), (12 + 439 / 505), (12 + 338 / 505), (12 + 237 / 505), (12 + 136 / 505), (12 + 35 / 505), (11 + 464 / 505), (12 + 36 / 505), (12 + 109 / 505), (12 + 189 / 505), (12 + 290 / 505), (12 + 392 / 505), (12 + 496 / 505), (13 + 118 / 505), (13 + 243 / 505), (13 + 388 / 505), (14 + 29 / 505), (14 + 174 / 505), (14 + 287 / 505), (14 + 312 / 505), (14 + (339 + 9684 / 41562) / 505), (14 + 361 / 505)], // 闕，以正光補之
        MoonLatiDifList: [0, 17, 16, 15, 12, 8, 4, 1, -2, -6, -10, -13, -15, -16, -(16 + 306 / 473)], // 乾象陰陽曆
    ...
    Jiayin: { // 嚴敦傑《補北齊書曆志》，《自然科學史研究》1984年第3期
        ...
        Denom: 22338, // 日法
        Anoma: 27 + 153195 / 276284, // 近點月。闕
        AnomaOrigin: 85000, // 闕，據紀差214931酌情增補。照理說應該是空，以後再說。
        MoonAcrVRaw: [14 + 483 / 676, 14 + 401 / 676, 14 + 314 / 676, 14 + 228 / 676, 14 + 133 / 676, 13 + 630 / 676, 13 + 356 / 676, 13 + 82 / 676, 12 + 587 / 676, 12 + 454 / 676, 12 + 320 / 676, 12 + 182 / 676, 12 + 47 / 676, 11 + 621 / 676, 12 + 46 / 676, 12 + 146 / 676, 12 + 253 / 676, 12 + 389 / 676, 12 + 524 / 676, 12 + 665 / 676, 13 + 155 / 676, 13 + 324 / 676, 13 + 519 / 676, 14 + 39 / 676, 14 + 233 / 676, 14 + 384 / 676, 14 + 417 / 676, 14 + (465 + 117513 / 162261) / 676, 14 + 483 / 676], // 闕，以天保補之
        OriginAd: 573 - 123399, // 武平四年癸巳
        // JdOrigin: 1930333.0145 - 123399 * (365 + 5461 / 22338),
        OriginYearSc: 1, // 上元甲子
        OriginMonNum: 0, // 
        ZhengNum: 2, // 建寅
    ...
    Tianhe: { // https://github.com/kanasimi/CeJS/blob/master/data/date/calendar.js 及武帝時，甄鸞造《天和曆》。上元甲寅至天和元年丙戌，積八十七萬五千七百九十二算外，章歲三百九十一，蔀法二萬三千四百六十，日法二十九萬一百六十，朔餘十五萬三千九百九十一，斗分五千七百三十一，會餘九萬三千五百一十六，曆餘一十六萬八百三十，冬至斗十五度，參用推步。終於宣政元年。
        ...
        ZhangLeap: 144, // 
        MansionRaw: [8, 15], // 斗15度
        MansionFractPosition: 8, // 闕，據興和補之
        NightList: [0, 27.5, 27.375, 26.875, 25.90625, 24.875, 23.453125, 22.375, 20.953125, 19.921875, 18.9375, 18.359375, 17.859375, 17.5, 17.890625, 18.375, 18.953125, 19.96875, 21.375, 22.46875, 23.90625, 24.953125, 25.96875, 26.890625, 27.421875, 27.5],
        DialList: [0, 13, 12.3, 11, 9.6, 7.95, 6.5, 5.25, 4.15, 3.2, 2.52, 1.98, 1.68, 1.5, 1.7, 2, 2.55, 3.33, 4.35, 5.5, 6.85, 8.4, 10, 11.4, 12.56, 13], // 以四分補之
        SunLatiList: [0, 115, 113 + 1 / 12, 110 + 8 / 12, 106 + 2 / 12, 101 + 1 / 12, 95 + 1 / 12, 89 + 1 / 12, 83 + 2 / 12, 77 + 10 / 12, 73 + 2 / 12, 69 + 8 / 12, 67 + 2 / 12, 67 + 1 / 12, 67 + 10 / 12, 70, 73 + 7 / 12, 78 + 7 / 12, 84 + 4 / 12, 90 + 7 / 12, 96 + 10 / 12, 102 + 4 / 12, 107 + 4 / 12, 110 + 11 / 12, 113 + 10 / 12, 115], // 景初同四分
    },
    Daxiang: { // https://github.com/kanasimi/CeJS/blob/master/data/date/calendar.js 大象元年，太史上士馬顯等，又上《丙寅元曆》...上元丙寅至大象元年己亥，積四萬一千五百五十四算上。日法五萬三千五百六十三，亦名蔀會法。章歲四百四十八，斗分三千一百六十七，蔀法一萬二千九百九十二。章中為章會法。日法五萬三千五百六十三，曆餘二萬九千六百九十三，會日百七十三，會餘一萬六千六百一十九，冬至日在斗十二度。小周餘、盈縮積，其曆術別推入蔀會，分用陽率四百九十九，陰率九。每十二月下各有日月蝕轉分，推步加減之，乃為定蝕大小餘，而求加時之正。
        ...
        MoonAcrVRaw: [14 + 483 / 676, 14 + 401 / 676, 14 + 314 / 676, 14 + 228 / 676, 14 + 133 / 676, 13 + 630 / 676, 13 + 356 / 676, 13 + 82 / 676, 12 + 587 / 676, 12 + 454 / 676, 12 + 320 / 676, 12 + 182 / 676, 12 + 47 / 676, 11 + 621 / 676, 12 + 46 / 676, 12 + 146 / 676, 12 + 253 / 676, 12 + 389 / 676, 12 + 524 / 676, 12 + 665 / 676, 13 + 155 / 676, 13 + 324 / 676, 13 + 519 / 676, 14 + 39 / 676, 14 + 233 / 676, 14 + 384 / 676, 14 + 417 / 676, 14 + (465 + 117513 / 162261) / 676, 14 + 483 / 676], // 闕，以天保補之。大象、張賔曆自成一系，不當用天保補。
        MoonLatiDifList: [0, 17, 16, 15, 12, 8, 4, 1, -2, -6, -10, -13, -15, -16, -(16 + 306 / 473)], // 乾象陰陽曆
    ...
    Yuanjia: {
        ...
        MoonAcrVRaw: [279, 277, 274, 270, 265, 260, 254, 249, 245, 242, 239, 236, 234, 232, 230, 232, 234, 237, 242, 248, 254, 259, 263, 267, 271, 274, 277, 278 + 103 / 417, 279],
        MoonLatiDifList: [0, 17, 16, 15, 12, 8, 4, 1, -2, -6, -10, -13, -15, -16, -(16 + 3472 / 5371)], // 元嘉陰陽曆
        ...
        ZhangRange: 19,
        ZhangLeap: 7,
        MansionRaw: [13, 2], // 劉洪濤：冬至在斗17，雨水日在室2度。由於日行盈縮，雨水本來是4度265+20/24分
        // MansionRaw: [13, 1 + 5 / 6], // 《中國古代曆法》27頁
        MansionFractPosition: 13, // 經室去度分
        // DayLight: [0, 45, 45.6, 46.7, 48.4, 50.5, 52.9, 55.5, 58, 60.3, 62.3, 63.9, 64.8, 65, 64.8, 63.9, 62.3, 60.3, 58, 55.5, 52.9, 50.5, 48.4, 46.7, 45.6], // 晝漏
        NightList: [0, 27.5, 27.2, 26.65, 25.8, 24.75, 23.55, 22.25, 21, 19.85, 18.85, 18.05, 17.6, 17.5, 17.6, 18.05, 18.85, 19.85, 21, 22.25, 23.55, 24.75, 25.8, 26.65, 27.2, 27.5],
        DialList: [0, 13, 12.48, 11.34, 9.91, 8.22, 6.72, 5.39, 4.25, 3.25, 2.5, 1.97, 1.69, 1.5, 1.69, 1.97, 2.5, 3.25, 4.25, 5.39, 6.72, 8.22, 9.91, 11.34, 12.48, 13], // 晷長
    ...
    Daming: {
        ...
        MoonAcrVRaw: [(14 + 13 / 23), (14 + 11 / 23), (14 + 8 / 23), (14 + 4 / 23), (13 + 22 / 23), (13 + 17 / 23), (13 + 11 / 23), (13 + 5 / 23), (12 + 22 / 23), (12 + 16 / 23), (12 + 11 / 23), (12 + 8 / 23), (12 + 6 / 23), (12 + 4 / 23), (12 + 5 / 23), (12 + 7 / 23), (12 + 10 / 23), (12 + 14 / 23), (12 + 19 / 23), (13 + 1 / 23), (13 + 7 / 23), (13 + 13 / 23), (13 + 19 / 23), (14 + 1 / 23), (14 + 6 / 23), (14 + 10 / 23), (14 + 12 / 23), (14 + (14 + 1010 / 1717) / 23), (14 + 13 / 23)], // 《古代曆法計算法》第303頁
        Node: 27 + 5598 / 26377, // 分母通法類似以往的月週 // NodeNumer: 358888.5, // 交點月一半的分子：交數。15987.5日餘。朔望合數=Lunar/2，差爲前限。
        MoonLatiDifList: [0, 16, 15, 14, 12, 9, 5, 1, -2, -6, -10, -13, -15, -16, -(16 + 3188 / 6395)], // 陰陽曆表遠離黃道益，接近黃道損
        ...
        // DayLight: [0, 45, 45.6, 46.7, 48.4, 50.5, 52.9, 55.5, 58.1, 60.4, 62.4, 63.9, 64.8, 65, 64.8, 63.9, 62.4, 60.4, 58.1, 55.5, 52.9, 50.5, 48.4, 46.7, 45.6], // 大明在元嘉基礎上微調
        // const TempA = NightList.slice()
        //  const TempB = TempA.reverse().slice(1, -1)
        //  et NightList = NightList.concat(TempB)
        NightList: [0, 27.5, 27.2, 26.65, 25.8, 24.75, 23.55, 22.25, 20.95, 19.8, 18.8, 18.05, 17.6, 17.5, 17.6, 18.05, 18.8, 19.8, 20.95, 22.25, 23.55, 24.75, 25.8, 26.65, 27.2, 27.5],
        DialList: [0, 13, 12.43, 11.2, 9.8, 8.17, 6.67, 5.37, 4.25, 3.26, 2.53, 1.99, 1.69, 1.5, 1.69, 1.99, 2.53, 3.26, 4.25, 5.37, 6.67, 8.17, 9.8, 11.2, 12.43, 13],
        SunLatiList: [0, 115, 113 + 1 / 12, 110 + 8 / 12, 106 + 2 / 12, 101 + 1 / 12, 95 + 1 / 12, 89 + 1 / 12, 83 + 2 / 12, 77 + 10 / 12, 73 + 2 / 12, 69 + 8 / 12, 67 + 2 / 12, 67 + 1 / 12, 67 + 10 / 12, 70, 73 + 7 / 12, 78 + 7 / 12, 84 + 4 / 12, 90 + 7 / 12, 96 + 10 / 12, 102 + 4 / 12, 107 + 4 / 12, 110 + 11 / 12, 113 + 10 / 12, 115], // 暫且沿用四分，沒改
    },
    Liangwu: { // 開元占經「梁武大同」，用來補明克讓。只有以下信息：《隋志中》「初，西魏入關，尚行李業興《正光術》。至武成元年，始詔克讓與麟趾學士庾季才及諸日者定新術，采祖暅舊議，通簡南北之術。自斯已後，頗親其謬。故周齊並時，而曆差一日。」跟元嘉大概三年有兩年差一天。陳久金《符天曆研究》：祖暅的符天經與後來的符天曆毫無關係。「采祖暅舊議」說明與大明很接近
        ...
        SolarNumer: 14469521,
        SolarDenom: 39616,
        Sidereal: 365 + 10449 / 39491, // 闕，以大明補之
        ...
        AnomaNumer: 42324,
        AnomaOrigin: 72500,
        MoonAcrVRaw: [(14 + 13 / 23), (14 + 11 / 23), (14 + 8 / 23), (14 + 4 / 23), (13 + 22 / 23), (13 + 17 / 23), (13 + 11 / 23), (13 + 5 / 23), (12 + 22 / 23), (12 + 16 / 23), (12 + 11 / 23), (12 + 8 / 23), (12 + 6 / 23), (12 + 4 / 23), (12 + 5 / 23), (12 + 7 / 23), (12 + 10 / 23), (12 + 14 / 23), (12 + 19 / 23), (13 + 1 / 23), (13 + 7 / 23), (13 + 13 / 23), (13 + 19 / 23), (14 + 1 / 23), (14 + 6 / 23), (14 + 10 / 23), (14 + 12 / 23), (14 + (14 + 1010 / 1717) / 23), (14 + 13 / 23)], // 闕，以大明補之
        OriginAd: 535 - 1025691, // 假設梁武帝大同元年。積年沒錯
        // JdOrigin: 1916454.5956 - 1025691 * (365 + 9681 / 39616),
        OriginYearSc: 1, // 上元闕
        OriginMonNum: 0, // 
        ZhengNum: 2, // 建寅
        MansionRaw: [8, 15], // 闕，以興和補
        MansionFractPosition: 8,
    ...
    Daye: { // 隋志的大業曆就是修改之後的，冬至起虛七。開元占經寫成了張曹玄
        ...
        NodeDenom: 391248,
        MoonAcrVRaw: [6010, 5950, 5880, 5800, 5710, 5620, 5530, 5430, 5330, 5240, 5160, 5090, 5020, 4960, 4980, 5040, 5110, 5190, 5270, 5360, 5450, 5550, 5640, 5730, 5810, 5890, 5950, 6000, 6010], // 《古代曆法計算法》第404頁，劉洪濤最後一個600改成333，但沒必要，因為28日入曆肯定不會在1413 / 2548以上。最後一個601不當有，我為了求轉差。我都乘了10，因為原算法涉及10倍轉換
        SunTcorrDifList: [0, 70, 35, 35, 20, 30, 35, -55, -45, -40, -30, -55, -65, -55, -40, -25, -5, -30, -40, 60, 55, 50, 45, 40, 10], // 入氣盈縮。我改變了後半部分正負。以日法為單位，月離表是以章為單位
        SunTcorrList: [0, 0, 70, 105, 140, 160, 190, 225, 170, 125, 85, 55, 0, -65, -120, -160, -185, -190, -220, -260, -200, -145, -95, -50, -10, 0],
        MoonLatiDifList: [0, 16, 15, 14, 12, 9, 5, 1, -2, -6, -10, -13, -15, -16, -(16 + 3188 / 6395)], // 大明陰陽曆
    ...
    Wuyin: { // 崔善爲修改的戊寅曆未改動傅仁均原始數據，《中國古代曆法》第460頁
        ...
        MoonAcrVRaw: [9909, 9810, 9695, 9563, 9414, 9266, 9118, 8953, 8788, 8640, 8508, 8392, 8277, 8178, 8211, 8310, 8425, 8557, 8689, 8837, 8986, 9151, 9299, 9447, 9578, 9710, 9809, 9891, 9909], // 
        SunTcorrDifList: [0, 896, 398, 400, 228, 341, 450, -500, -455, -355, -555, -848, -739, -626, -456, -288, -40, -342, -455, 682, 625, 570, 513, 456, 100],
        SunTcorrList: [0, 0, 896, 1294, 1694, 1922, 2263, 2713, 2213, 1758, 1403, 848, 0, -739, -1365, -1821, -2109, -2149, -2491, -2946, -2264, -1639, -1069, -556, -100, 0],
        MoonLatiDifList: [0, 16, 15, 14, 12, 9, 5, 1, -2, -6, -10, -13, -15, -16, -(16 + 3188 / 6395)], // 大明陰陽曆
