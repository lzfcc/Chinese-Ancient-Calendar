export default {
    ...
    Daming: {
        ...
        //   NightList = NightList.concat(TempB)
    ...
    Daye: { // 隋志的大業曆就是修改之後的，冬至起虛七。開元占經寫成了張曹玄
        ...
        SunTcorrDifList: [70, 35, 35, 20, 30, 35, -55, -45, -40, -30, -55, -65, -55, -40, -25, -5, -30, -40, 60, 55, 50, 45, 40, 10], // 入氣盈縮。我改變了後半部分正負。以日法為單位，月離表是以章為單位
