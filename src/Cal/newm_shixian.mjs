...
// const sunCorrXinfaZhunduifen = Xraw => { 
//     Xraw = (Xraw + 360) % 360
...
//     }
// }
const sunCorrXinfa = Sorb => { // 廖育棟文檔改編。從上到下D、本輪心O、地心C，CO=OD=E，太陽在S，作OH⊥CS，DJ⊥CS。《後編》《用橢圓面積爲平行》「新法算書第谷所定之最大差爲2度3分11秒=2.05305」《求兩心差》「新法算書日躔中距之盈縮差爲2度3分9秒40微=2.052685」
    const E = .0179208
    const OH = sin(Sorb) * E
    const CH = cos(Sorb) * E
    const DJ = 2 * OH
