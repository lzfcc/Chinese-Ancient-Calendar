...
export const HouList = ['',
    '蚯蚓結', '麋角解', '水泉動', // 0冬至
    '鴈北向', '鵲始巢', '雉始雊', // 十二月1小寒4。小寒之後丑2開始建除
    '雞始乳', '鷙鳥疾', '冰腹堅', // 2大寒。
    '東風解', '蟄蟲振', '魚上冰', // 一月3立春。
    '獺祭魚', '鴻鴈來', '草萌動', // 4雨水。麟徳、戊寅雨水驚蟄顛倒，大業、皇極與現在一樣
    '桃始華', '倉庚鳴', '鷹化鳩', // 二月5驚蟄第16候，卯4開始建除
    '玄鳥至', '雷發聲', '電始見', // 6春分
    '桐始華', '田鼠爲鴽', '虹始見', // 三月7清明22
    '萍始生', '鳩拂羽', '戴勝降桑', // 8穀雨    
    '螻蟈鳴', '蚯蚓出', '王瓜生', // 四月9立夏28
    '苦菜秀', '蘼草死', '麥秋至', // 10小滿
    '螳螂生', '鵙始鳴', '反舌無聲', // 五月11芒種34
    '鹿角解', '蜩始鳴', '半夏生', // 12夏至爲第37候，庚7，虛長在第三個庚爲初伏，第四個庚中伏，立秋後第一個庚末伏
    '溫風至', '蟋蟀居壁', '鷹學習', // 六月13小暑40
    '腐草爲螢', '地潤溽暑', '大雨行', // 14大暑
    '涼風至', '白露降', '寒蟬鳴', // 七月15立秋46
    '鷹祭鳥', '天地肅', '禾乃登', // 16處暑
    '鴻鴈來', '玄鳥歸', '鳥養羞', // 八月17白露52
    '雷收聲', '蟄蟲附戶', '始涸', // 18秋分
    '鴻鴈來賓', '雀入爲蛤', '菊有黃花', // 九月19寒露58
    '豺祭獸', '草黄落', '蟄虫俯', // 20霜降
    '始冰', '地始凍', '雉入爲蜃', // 十月21立冬64
    '虹藏', '冰益壯', '地始坼', // 22小雪
    '鶡鴠不鳴', '虎始交', '荔挺出', // 十一月23大雪70
