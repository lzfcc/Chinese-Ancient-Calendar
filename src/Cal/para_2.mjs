export default {
    ...
    Dayan: { // 《中國古代曆法》第427頁。大衍宣明崇玄三個遠地點
        ...
        // MoonAcrV: [917, 930, 943, 956, 970, 984, 1000, 1018, 1037, 1051, 1065, 1079, 1092, 1105, 1112, 1099, 1086, 1073, 1059, 1045, 1028, 1010, 992, 978, 964, 950, 937, 924, 923], // 最後一個923沒有,我爲了算列衰
    ...
    Yingtian: { // 宋志一
        ...
        Sidereal: 365 + 2563.1888 / 10002, // 這個根據天總*5再減一點。「小餘2563微88」不懂。下三曆的虛分跟週天有細微差別，爲何
    ...
    Guantian: { // 宋志十
        ...
        Node: 27 + 2551.9944 / 12030, // 朔差日2+3831.0056/12030。從各方面來看，這個數字都沒錯，爲何入交日差了那麼多？？     
    ...
    Yiwei: { // 乙未元曆《李氏遺書》。元志八。《授時曆議》「大定二十年庚子耶律履（耶律楚材之父）造，不見行用，至辛巳後天一十九刻」那麼應該是用授時作爲標準。李銳說是20690，授時曆議2690。若用2690.朔實就不對 積年都不對，前後一萬年看了，閏餘差最小也是0.13。不行，還是求不出來
