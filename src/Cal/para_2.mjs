export default {
    ...
    Jiyuan: { // 宋志十二
        ...
        // MoonTcorrDifList: [-714, -654, -573, -464, -338, -196, -55, 88, 229, 360, 490, 595, 670, 726, 703, 643, 551, 429, 307, 164, 22, -120, -256, -388, -512, -611, -687] // 損益率，本來是益損益損
        MoonTcorrDifList: [
            -714, -654, -573, -464, -338, -196, -60, 5,
            88, 229, 360, 490, 595, 670, 726,
            703, 643, 551, 429, 307, 164, 38, -16,
            -120, -256, -388, -512, -611, -687, -409] // 損益率，特殊處理各節點
    },
    Tongyuan: { // 宋志十六
        Solar: 365 + 1688 / 6930, // 
