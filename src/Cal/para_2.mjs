export default {
    ...
    Yiwei: { // 乙未元曆《李氏遺書》。元志八。《授時曆議》「大定二十年庚子耶律履（耶律楚材之父）造，不見行用，至辛巳後天一十九刻」那麼應該是用授時作爲標準。李銳說是20690，授時曆議2690。若用2690.朔實就不對 積年都不對，前後一萬年看了，閏餘差最小也是0.13。不行，還是求不出來。最後用曲安京復原結果
        Solar: 365 + 5040 / 20690,
        Sidereal: 365 + 5313.1465 / 20690,
