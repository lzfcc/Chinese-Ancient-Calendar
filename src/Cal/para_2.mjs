export default {
    Zhangmengbin: { // 嚴敦傑《補北齊書曆志》，《自然科學史研究》1984年第3期
        ...
        TermRangeS: 160 / 11,
        AcrTermList: [0, 14.68005, 29.437022, 44.270918, 59.104814, 73.861787, 88.541836, 104.298809, 119.978859, 135.581986, 151.185112, 166.865162, 182.622135, 198.379107, 214.059157, 229.662284, 245.26541, 260.94546, 276.702433, 291.382482, 306.139455, 320.973351, 335.807247, 350.564219, 365.244269], // 皇極躔
    ...
    Dayan: { // 《中國古代曆法》第427頁。大衍宣明崇玄三個遠地點
        ...
        AcrTermList: [0, 14.444504, 29.056113, 43.817393, 58.714857, 73.739953, 88.888076, 104.176987, 119.588925, 135.128495, 150.804249, 166.629674, 182.622204, 198.614734, 214.440159, 230.115913, 245.655482, 261.067421, 276.356332, 291.504454, 306.52955, 321.427015, 336.188295, 350.799904, 365.244408, 379.688912],
        ...
        MoonLatiDifList: [187, 171, 147, 115, 75, 27, -27, -75, -115, -147, -171, -187], // 大衍加減率 /120爲度
        MoonLatiAccumList: [0, 187, 358, 505, 620, 695, 722, 695, 620, 505, 358, 187, 0, -187, -358], // 大衍陰陽積
    },
    Zhide: { // 在大衍的基礎上每節增二日
        Solar: 365 + 743 / 3040,
        SolarNumer: 1110343, // 策實
    ...
    Wuji: { // 新唐志五
        ...
        AcrTermList: [0, 14.444652, 29.056468, 43.817537, 58.715174, 73.740423, 88.888806, 104.177488, 119.589303, 135.128731, 150.804726, 166.629975, 182.622388, 198.614801, 214.44005, 230.116045, 245.655473, 261.067289, 276.35597, 291.504353, 306.529602, 321.427239, 336.188308, 350.800124, 365.244776, 365.244776 + 14.444652],
    ...
    Zhengyuan: { // 新唐志五
        ...
        AcrTermList: [0, 14.444102, 29.05624, 43.817237, 58.715221, 73.740145, 88.888356, 104.177207, 119.589346, 135.128425, 150.80449, 166.629414, 182.622374, 198.615335, 214.440259, 230.116324, 245.655403, 261.067542, 276.356393, 291.504604, 306.529528, 321.427511, 336.188508, 350.800647, 365.244749, 365.244749 + 14.444102],
    ...
    Xuanming: { //
        ...
        AcrTermList: [0, 14.504241, 29.12753, 43.869866, 58.73125, 73.735491, 88.882589, 104.172545, 119.605357, 135.181027, 150.875744, 166.689509, 182.622321, 198.555134, 214.368899, 230.063616, 245.639286, 261.072098, 276.362054, 291.509152, 306.513393, 321.374777, 336.117113, 350.740402, 365.244643, 365.244643 + 14.504241],
    ...
    Yingtian: { // 宋志一
        ...
        MoonAcrVA: [1210, 1227, 1245, 1262, 1281, 1301, 1321, 1345, 1369, 1390, 1415, 1435, 1456, 1470],
        MoonAcrVB: [1470, 1453, 1432, 1406, 1380, 1358, 1337, 1325, 1294, 1274, 1256, 1240, 1225, 1210], // 離分.度母10000
    ...
    Jiyuan: { // 宋志十二
        ...
        SunTcorrList: [0, 385, 708, 965, 1153, 1269, 1309, 1369, 1153, 965, 708, 385, 0, -385, -708, -965, -1153, -1269, -1309, -1369, -1153, -965, -708, -385, 0, 385],
    ...
    Huiyuan: { // 宋志
        ...
        MansionRaw: [11, 7],
        MansionFractPosition: 11,
        SunAcrAvgDifList: [7108, 5773, 4456, 3159, 1881, 623, -623, -1881, -3159, -4456, -5773, -7108, -7108, -5773, -4556, -3159, -1881, -623, 623, 1881, 3159, 4456, 5773, 7108, 7108], // 乘法119除法1811.為何會元淳熙除法不同？
    ...
    Tongtian: { // 以下三個宋志十七。統天在氣朔、交食、五星計算上沒什麼創新，特色是消長、積年。積年僅僅是甲子日，其他什麼都不是——這就是授時的理論來源
        ...
        MansionRaw: [11, 7],
        MansionFractPosition: 11,
        SunAcrAvgDifList: [7000, 5840, 4630, 3370, 2060, 700, -700, -2060, -3370, -4630, -5840, -5840, -7000, -5840, -4630, -3370, -2060, -700, 700, 2060, 3370, 4630, 5840, 5840, 7000], // 盈縮分。乘法380，除法5783
    ...
    Kaixi: {
        ...
        MansionRaw: [11, 7],
        MansionFractPosition: 11,
        SunAcrAvgDifList: [7445, 5951, 4524, 3164, 1871, 645, -645, -1871, -3164, -4524, -5951, -5951, -7445, -5951, -4524, -3164, -1871, -645, 645, 1871, 3164, 4524, 5951, 5951, 7445], // 升降分。乘法206除法3135
    ...
    Chunyou: { // 《李氏遺書》
        ...
        AcrTermList: [0, 14.496961, 29.126922, 43.888582, 58.780643, 73.801804, 88.950765, 104.238726, 119.654486, 135.199347, 150.874608, 166.681569, 182.62153, 198.561491, 214.368451, 230.043712, 245.588573, 261.004334, 276.292295, 291.441255, 306.462416, 321.354477, 336.116138, 350.746099, 365.243059],
        OriginAd: -32628838,
    ...
    Huitian: { // 《李氏遺書》。根據寶祐四年會天曆來看，冬至時刻癸丑卯正初刻，成天是卯初四刻。會天通過暴力破解得到
        ...
        AcrTermList: [0, 14.496946, 29.126893, 43.888539, 58.780585, 73.801731, 88.950678, 104.238624, 119.65437, 135.199216, 150.874463, 166.681409, 182.621355, 198.561302, 214.368248, 230.043494, 245.58834, 261.004087, 276.292033, 291.440979, 306.462125, 321.354172, 336.115818, 350.745764, 365.24271],
        OriginAd: -75637730,
    ...
    NewDaming: { // 金志上。「時翰林應奉耶律履亦造乙未曆。二十一年十一月望，太陰虧食，遂命尙書省委禮部員外郞任忠傑與司天曆官驗所食時刻分秒，比校知微、履及見行曆之親疏，以知微曆爲親，遂用之。」
        ...
        MansionRaw: [11, 7], // 命起赤道虛宿七度外去之
        MansionFractPosition: 11,
        SunAcrAvgDifList: [7059, 5920, 4718, 3453, 2126, 739, -739, -2126, -3453, -4718, -5920, -7059, -7059, -5920, -4718, -3453, -2126, -739, 739, 2126, 3453, 4718, 5920, 7059, 7059], // 《日積度及盈縮》損益率。重修大明有三個日表
        SunDifAccumList: [0, 0.7059, 1.2979, 1.7697, 2.115, 2.3276, 2.4015, 2.3276, 2.115, 1.7697, 1.2979, 0.7059, 0, -0.7059, -1.2979, -1.7697, -2.115, -2.3276, -2.4015, -2.3276, -2.115, -1.7697, -1.2979, -0.7059, 0, 0.7059],
    ...
    Yiwei: { // 乙未元曆《李氏遺書》。元志八。《授時曆議》「大定二十年庚子耶律履（耶律楚材之父）造，不見行用，至辛巳後天一十九刻」那麼應該是用授時作為標準。李銳說是20690，授時曆議2690。若用2690.朔實就不對 積年都不對，前後一萬年看了，閏餘差最小也是0.13。不行，還是求不出來
        ...
        AcrTermList: [0, 14.512583, 29.139066, 43.885749, 58.758933, 73.764816, 88.909399, 104.201782, 119.632865, 135.196648, 150.886932, 166.697415, 182.621798, 198.546181, 214.356664, 230.046947, 245.610731, 261.041814, 276.334197, 291.47878, 306.484663, 321.357846, 336.10453, 350.731013, 365.243596],
        SunDifAccumList: [0, 0.7059, 1.2979, 1.7697, 2.115, 2.3276, 2.4015, 2.3276, 2.115, 1.7697, 1.2979, 0.7059, 0, -0.7059, -1.2979, -1.7697, -2.115, -2.3276, -2.4015, -2.3276, -2.115, -1.7697, -1.2979, -0.7059, 0, 0.7059],
