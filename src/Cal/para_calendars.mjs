export default {
    ...
    Huangji: {
        ...
        // const MoonAvgVd = parseFloat((Sidereal / Lunar + 1).toPrecision(13))
    },
    Yisi: {
        Type: 6,
        Solar: 365 + 328 / 1340,
    ...
    West: {
        ...
        OriginAd: 1281,
        // JdOrigin: 2188925.5,
        SolarRaw: 365.24218968, // 365.24218968-.0000000616*(year-2000) 
        Solar: 365.2425,
        Sidereal: 365.25636042,
        LunarRaw: 29.53058885, // 29.53058885+.0000000022*(year-2000)
        Anoma: 27.554551,
        SolsConst: 55.08125,
        FirstConst: 20.2,
        AnomaConst: 13.17,
    ...
    Xinfa: { // 新法曆書
        ...
        BjLat: 39.9167, // 順天府39度55分。日躔曆指葉19「順天府北極出地之度有三說，未知孰是」
