export default {
    ...
    Xinfa: { // 新法曆書
        ...
        Lunar: 29.530593, // 月離曆指「今新曆表所用率」29.530692
        Precession: 51 / 3600,
        ...
        MoonAvgVd: 13.1763539026105, // 根據Vm·Lunar=VS·Lunar+360
        Anoma: 27.55584749,
        MapoVd: .1119761796, // 根據：MoonAvgVd-360/Anoma
        Node: 27.21219674,
        NodeVd: .05300804579, // 根據(NodeVd+MoonAvgVd)*Node=360
        MoonNodeVdSum: 13.2293619453, // 待定
        ...
        MapoConst: 336.311, // 月離表冬至次日月孛行11宮6度19分，交食表首朔太陰引數1宮7度34分34秒=37.57612。算得首朔月孛337.7706092118，算得冬至次日月孛336.1262099
        NodeConst: 30.0039, // 月離表冬至正交行1宮0度0分14秒=30.0039，交食表首朔交周度5宮15度50分49秒=165.84695。由冬至算得首朔正交29.2254630655
    ...
    Yongnian: { // 康熙永年曆法。日躔表：自曆元戊辰年後戊午起至辛丑年止。月離表：自曆元戊辰二百年後戊子起至己酉年止。月離三項平行參數與崇禎曆書無縫銜接
        ...
        MoonAvgVd: 13.1763539026105, // 根據Vm·Lunar=VS·Lunar+360得13.1763538995。根據永年表，22+33/60+38/3600+20/216000-(9+23/60+3/3600+19/216000)=13.17639
        Anoma: 27.55584749,
        MapoVd: .1119761796, // 根據：MoonAvgVd-360/Anoma
        Node: 27.21219674,
        NodeVd: 0.05300804579, // 根據(NodeVd+MoonAvgVd)*Node=360
        MoonNodeVdSum: 13.2293619453, // 待定
        ChouConst: 14.68526,
    ...
    Jiazi: { // 曆象考成
        ...
        MoonAvgVd: 13.17639477138889, // 47435.021177秒 // 精確：Vm·Lunar=VS·Lunar+360=13.17639477141213
        ...
        Node: 27.212233, // 交終        
        NodeVd: 0.05295555553333, // 新數=每交退行/Node=5187.120402/3600/27.212233=.052949229794311比舊數少一微，今仍用舊數。正交平行3分10秒38微=、190.64秒=.05295555555556
