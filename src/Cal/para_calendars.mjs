export default {
    ...
    Jiazi: { // 曆象考成
        ...
        SunAvgVd: .98564736580556, // 每日平行3548.3305169 / 3600
        SperiVy: .01699074074074, // 最卑perihelion每歲平行″1/60+1/3600+10/216000
        SperiVd: .00004651916667, // .167469秒
        SperiConst: 7.1697682963, // 7°10′11″10太陽最卑應
        ...
        MapoVd: .11141041027778, // 月孛每日平行401.077477/3600
        NodeVd: .05295555555556, // 正交平行190.64秒
        // 13.2293503267每日太陰交周
        ...
        AvgMoonLimit: 14.9,
        MoonLimit: 12.28194444444444, // 12+16/60+55/3600
    },
    Guimao: { // 曆象考成後編
        Type: 13,
        ApplyYear: [[1734, 1913]],
        ...
        // Precession: 51 / 3600, // 岁差51″
        Lunar: 29.53059053,
        SunAvgVd: .98564696935166, // 太陽每日平行″        
        SperiVy: .01749930555556, // 最卑perihelion每歲平行62.9975″，
        SperiVd: .00004791111111, // .17248 / 3600。精確的是0.00004791149302
        SperiConst: 8.1256578519, // 8°7′32″22。最卑應：天正平冬至次日子正初刻最卑過冬至之度分
        MoonAvgVd: 13.17639539127778, // 太陰每日平行47435.0234086 / 3600
