export default {
    ...
    Jiazi: { // 曆象考成
        Type: 13,
        ApplyYear: [[1727, 1733]],
        CloseOriginAd: 1684, // 康熙二十三年甲子冬至次日子正爲曆元
        Solar: 365.2421875, // 週歲
        // Precession: 51 / 3600, // 岁差51″
        SunAvgDV: 0.98564736580556, // 每日平行3548.3305169 / 3600
        SunperiYV: 0.01699074074074, // 最卑perihelion每歲平行″1/60+1/3600+10/216000
        SunperiDV: 0.167469 / 3600,
    ...
    Guimao: { // 曆象考成後編
        ...
        // Precession: 51 / 3600, // 岁差51″
        Lunar: 29.53059053,
        SunAvgDV: 0.98564696935166, // 太陽每日平行″        
        SunperiYV: 0.01749930555556, // 最卑perihelion每歲平行62.9975″，
        SunperiDV: 0.00004791111111, // 0.17248 / 3600。精確的是0.00004791149302
        SunperiConst: 8.1256578519, // 8°7′32″22。最卑應：天正平冬至次日子正初刻最卑過冬至之度分
        MoonAvgDV: 13.17639539127778, // 太陰每日平行47435.0234086 / 3600
        MoonapoDV: 0.11140839611111, //401.070226 / 3600
        MoonapoConst: 241.26267592592593, // 太陰最高應8 * 30 + 1 + 15 / 60 + 45 / 3600 + 38 / 216000
        NodeDV: 0.052955175, // 190.63863 / 3600
        ...
        ChouWhitelongiConst: 203.6146712962963, // 6 * 30 + 23 + 36 / 60 + 52 / 3600 + 49 / 216000首朔太陰交周應：癸卯首朔太陰距正交之行度，MoonConst-NodeConst+NewmConst*MoonPLUSNodeDV=(5 * 30 + 26 + 27 / 60 + 48 / 3600 + 53 / 216000)-(5 * 30 + 22 + 57 / 60 + 37 / 3600 + 33 / 216000)+15.12633*(13+13/60+45/3600+39/216000+43/216000/60+20/216000/3600+34/216000/216000)=203.6146705038
