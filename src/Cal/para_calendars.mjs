export default {
    ...
    Jiazi: { // 曆象考成
        ...
        SunAvgVd: 0.98564736580556, // 每日平行3548.3305169 / 3600
        SunperiVy: 0.01699074074074, // 最卑perihelion每歲平行″1/60+1/3600+10/216000
        SunperiVd: 0.00004651916667, // 0.167469秒
        SunperiConst: 7.1697682963, // 7°10′11″10。最卑應
        // Lunar: ,
        // Node: ,
        // Anoma: , // 
    ...
    Guimao: { // 曆象考成後編
        ...
        // Precession: 51 / 3600, // 岁差51″
        Lunar: 29.53059053,
        SunAvgVd: 0.98564696935166, // 太陽每日平行″        
        SunperiVy: 0.01749930555556, // 最卑perihelion每歲平行62.9975″，
        SunperiVd: 0.00004791111111, // 0.17248 / 3600。精確的是0.00004791149302
        SunperiConst: 8.1256578519, // 8°7′32″22。最卑應：天正平冬至次日子正初刻最卑過冬至之度分
        MoonAvgVd: 13.17639539127778, // 太陰每日平行47435.0234086 / 3600
        MoonapoVd: 0.11140839611111, //401.070226 / 3600
        MoonapoConst: 241.26267592592593, // 太陰最高應8 * 30 + 1 + 15 / 60 + 45 / 3600 + 38 / 216000
        ...
        MoonapoConst: 241.26267592592593, // 最高應8 * 30 + 1 + 15 / 60 + 45 / 3600 + 38 / 216000
        ...
        Obliquity: 23.48333333333333, // 黃赤大距        
