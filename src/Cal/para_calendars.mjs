export default {
    ...
    Shiji: {
        ...
        BuRange: 76, // 蔀
        isTermLeap: 1, // 是否用無中氣置閏法
        SolsConst: -.75, // 去掉零頭。太初曆藉半日法其實就已經是去掉零頭了的
        EcliRange: 135 / 23,
        EcliNumer: 513,
    },
    Taichu: {
    ...
    Easthan: {
        ...
        SunLatList: [115, 113 + 1 / 12, 110 + 8 / 12, 106 + 2 / 12, 101 + 1 / 12, 95 + 1 / 12, 89 + 1 / 12, 83 + 2 / 12, 77 + 10 / 12, 73 + 2 / 12, 69 + 8 / 12, 67 + 2 / 12, 67 + 1 / 12, 67 + 10 / 12, 70, 73 + 7 / 12, 78 + 7 / 12, 84 + 4 / 12, 90 + 7 / 12, 96 + 10 / 12, 102 + 4 / 12, 107 + 4 / 12, 110 + 11 / 12, 113 + 10 / 12, 115, 113 + 1 / 12], // 太陽去極度。111弱我暫時處理成110+11/12。106少強改成少弱
        Sobliq: 23.9, // 據緯度最大值
        RiseLat: 34.684,
        DialLat: 34.402,
    },
    ...
    Qianxiang: {
        ...
        cM: .04708081027831, // 根據遲疾積極值爲2e算得偏心率
        MoonLatDifList: [17, 16, 15, 12, 8, 4, 1, -2, -6, -10, -13, -15, -16, -(16 + 306 / 473)], // 乾象陰陽曆。/12爲度
        MoonLatAccumList: [0, 1.4166666666666667, 2.75, 4, 5, 5.666666666666667, 6, 6.083333333333333, 5.916666666666667, 5.416666666666667, 4.583333333333333, 3.5, 2.25, .916666666666667, -.4705778717406],
    ...
    Jingchu: {
        ...
        cM: .04944868524093, //  極值在f6.46153846153846156=5.7489878543
    ...
    Tsrengguang: {
        ...
        cM: .05432482456639, //  2762,3047——285，3127,3002——125，3047+285x=3127+125(1-x) , x=.5 極值在6.5，3189.5
    ...
    Xinghe: {
        ...
        cM: .05427411044523, // 極值在f6.5022026431718062= 3546.193832599119
    ...
    Tianbao: { // https://github.com/kanasimi/CeJS/blob/master/data/date/calendar.js // 嚴敦傑《補北齊書曆志》，《自然科學史研究》1984年第3期
        ...
        cM: .05427368767647, // 極值f6.5=4265.5
    ...
    Yuanjia: {
        ...
        cM: .04695727840403, // 極值f6.4545454545454545=103.7272727272727
        MoonLatDifList: [17, 16, 15, 12, 8, 4, 1, -2, -6, -10, -13, -15, -16, -(16 + 3472 / 5371)], // 元嘉陰陽曆
        MoonLatAccumList: [0, 1.416666666666666667, 2.75, 4, 5, 5.666666666666667, 6, 6.083333333333333, 5.916666666666667, 5.416666666666667, 4.583333333333333, 3.5, 2.25, .916666666666667, -.4705362129957],
    ...
    Daming: {
        ...
        MoonDifAccumList: [0, 467.71165998, 901.42331996, 1284.13497994, 1598.84663992, 1828.5582999, 1973.26995988, 2015.98161986, 1956.69327984, 1795.40493982, 1532.1165998, 1183.82825978, 784.53991976, 351.25157974, -116.03676028, -566.3251003, -982.61344032, -1347.90178034, -1645.19012036, -1857.47846038, -1984.7668004, -2010.05514042, -1933.34348044, -1754.63182046, -1490.92016048, -1142.2085005, -725.49684052, -274.78518054, 219.92647944],
        cM: .0450005295617, // 極值f6.5=2045.62578987
        Node: 27 + 5598 / 26377, // 分母通法類似以往的月週 // NodeNumer: 358888.5, // 交點月一半的分子：交數。15987.5日餘。朔望合數=Lunar/2，差爲前限。
        MoonLatDifList: [16, 15, 14, 12, 9, 5, 1, -2, -6, -10, -13, -15, -16, -(16 + 3188 / 6395)], // 陰陽曆表遠離黃道益，接近黃道損
        MoonLatAccumList: [0, 1.3333333333333333, 2.583333333333333, 3.75, 4.75, 5.5, 5.916666666666667, 6, 5.833333333333333, 5.333333333333333, 4.5, 3.416666666666667, 2.166666666666667, .833333333333333, -.5415428720354],
        ...
        OriginMonNum: 0, // 
        ZhengNum: 2, // 建寅
        MansionRaw: [11, 0], // 上元虛初度。從上元到463年，大概退了35度，從虛初退，正好是斗12左右
        MansionFracPosi: 10, // 虛前，入虛去度分 
        ...
        NightList: [27.5, 27.2, 26.65, 25.8, 24.75, 23.55, 22.25, 20.95, 19.8, 18.8, 18.05, 17.6, 17.5, 17.6, 18.05, 18.8, 19.8, 20.95, 22.25, 23.55, 24.75, 25.8, 26.65, 27.2, 27.5], // 元嘉
    ...
    Daye: { // 隋志的大業曆就是修改之後的，冬至起虛七。占經寫成了張曹玄
        ...
        cM: .04525290697392, // f6.5263157894736818=2157.0609136842104
    ...
    Wuyin: { // 戊寅定朔 // 崔善爲修改的戊寅曆未改動傅仁均原始數據，《中國古代曆法》第460頁
        ...
        cM: .045242518616, // f6.5271565495207667=3555.7188498402556
    ...
    Huangji: {
        ...
        cS: .02381824,
        cM: .04665095, // 極值f6.9166665222222=5.42387828472222
        ...
        MoonTcorrDifList: [-123, -111, -97, -77, -56, -32, -9.05, .05, 13, 38, 63, 84, 100, 113, 122, 120, 108, 91, 72, 52, 29, 5.45454545454545, -.45454545454545, -18, -41, -66, -87, -105, -118, -70],
        ...
        DialList: [13, 12.43, 11.2, 9.8, 8.17, 6.67, 5.37, 4.25, 3.26, 2.53, 1.99, 1.69, 1.5, 1.69, 1.99, 2.53, 3.26, 4.25, 5.37, 6.67, 8.17, 9.8, 11.2, 12.43, 13, 12.43], // 大明
        SunLatList: [115, 113 + 1 / 12, 110 + 8 / 12, 106 + 2 / 12, 101 + 1 / 12, 95 + 1 / 12, 89 + 1 / 12, 83 + 2 / 12, 77 + 10 / 12, 73 + 2 / 12, 69 + 8 / 12, 67 + 2 / 12, 67 + 1 / 12, 67 + 10 / 12, 70, 73 + 7 / 12, 78 + 7 / 12, 84 + 4 / 12, 90 + 7 / 12, 96 + 10 / 12, 102 + 4 / 12, 107 + 4 / 12, 110 + 11 / 12, 113 + 10 / 12, 115, 113 + 1 / 12], // 四分
        Sobliq: 23.9, // 據0度緯度
        MoonLatDifList: [14, 13, 11.5, 9.5, 7, 4, 1.5, -2, -5, -8, -10.5, -12.5, -13.5, -14.2], // 最後一個不知對不對。月距黃道。/10爲度
        MoonLatAccumList: [0, 14, 27, 38.5, 48, 55, 59, 60, 58, 53, 45, 34.5, 22, 8.5],
    ...
    Linde: {
        ...
        MoonLatDifList: [14, 13, 11.5, 9.5, 7, 4, .05, -2, -5, -8, -10.5, -12.5, -13.5, -14.25], // 去交差。中間是進二退二。/10爲度。第二個9.5原爲11.5，似乎錯了
        MoonLatAccumList: [0, 14, 27, 38.5, 48, 55, 59, 60, 58, 53, 45, 34.5, 22, 8.5], // 差積。跟皇極幾乎沒區別
        ...
        SunLatList: [115.3, 114.1, 111.7, 107.9, 102.9, 97.3, 91.3, 85.3, 79.7, 74.7, 70.9, 68.5, 67.3, 68.5, 70.9, 74.7, 79.7, 85.3, 91.3, 97.3, 102.9, 107.9, 111.7, 114.1, 115.3, 114.1], // 黃道去極《古代曆法》46頁
        Sobliq: 24,
    ...
    Dayan: {
        ...
        MansionRaw: [11, 9],
        MansionFracPosi: 11, // 命起赤道虛九，宿次去之，經虛去分，至不滿宿算外，得冬至加時日度。
        ...
        SunLatList: [115.2, 114.35, 111.9, 108.05, 103.2, 97.3, 91.3, 85.3, 79.4, 74.55, 70.7, 68.25, 67.4, 68.25, 70.7, 74.55, 79.4, 85.3, 91.3, 97.3, 103.2, 108.05, 111.9, 114.35, 115.2, 114.35], // 定氣黃道去極度
        Sobliq: 23.9, // 據115.2
        MoonLatDifList: [187, 171, 147, 115, 75, 27, -27, -75, -115, -147, -171, -187, 178], // 大衍加減率 /120爲度
        MoonLatAccumList: [0, 187, 358, 505, 620, 695, 722, 695, 620, 505, 358, 187], // 大衍陰陽積
    ...
    Wuji: { // 新唐志五
        ...
        MoonLatDifList: [24, 17, 11, 8, 11, 17, 12, -17, -11, -8, -11, -17, -24, -12, 24],
    ...
    Tsrengyuan: { // 新唐志五
        ...
        MoonLatDifList: [78, 56, 36, 26, 36, 56, 39, -56, -36, -26, -36, -56, -78, -39, 78],
        MoonLatAccumList: [0, 78, 134, 170, 196, 232, 288, 327, 271, 235, 209, 173, 117, 39],
    },
    Xuanming: {
        Type: 7,
        isAcr: true,
    ...
    Chongxuan: { // 新唐志六下。崇玄發揚了符天的公式化，符天：平行實行差=(182-平行度)*平行度/3300「相減相乘」。陳美東《中國古代有關曆表及其算法的公式化》，《自然科學史研究》1988年第3期
        ...
        MansionDayConst: -16,
        MansionRaw: [11, 4],
        MansionFracPosi: 11, // 其上元七曜，起赤道虛四度。
    ...
    Jiuzhi: { //我沒怎麼遵照原始的算法，只是用sin算定日月。顧觀光《九執曆解》，《武陵山人遺書》，《中國科學技術典籍通匯》天文部分第843頁。開元占經卷104。度分體系：360度，1度=60分，跟現在完全一樣。電子版可參https://www.eee-learning.com/book/kaiyenjan104
        ...
        MoonAcrVdDeg: [0, -77, -71, -61, -47, -30, -10, 10, 30, 47, 61, 71, 77, 77, 71, 61, 47, 30, 10, -10, -30, -47, -61, -71, -77, -77], // 月段六。原文：77, 71, 61, 47, 30, 10
    ...
    Yingtian: { // 宋志一
        ...
        SunLatList: [115.2, 114.58, 112.32, 108.67, 103.81, 97.93, 91.31, 84.67, 78.79, 73.92, 70.27, 68.02, 67.39, 68.02, 70.27, 73.92, 78.79, 84.67, 91.31, 97.93, 103.81, 108.67, 112.32, 114.58, 115.2, 114.58], // 《中國古代曆法》頁46
        Sobliq: 23.9, // 據0度緯度
        RiseLat: 34.402,
        DialLat: 34.402,
    },
    Qianyuan: { // 宋志一
        ...
        SunLatList: [115.2, 114.58, 112.32, 108.67, 103.81, 97.93, 91.31, 84.67, 78.79, 73.92, 70.27, 68.02, 67.39, 68.02, 70.27, 73.92, 78.79, 84.67, 91.31, 97.93, 103.81, 108.67, 112.32, 114.58, 115.2, 114.58], // 應天
        Sobliq: 23.9, // 據0度緯度
        RiseLat: 34.812,
        DialLat: 34.812,
    },
    ...
    Shoushi: { // 授時曆經
        ...
        Sobliq: 23.9, // 實測23.9
        cS: .02065366, // 極值2.4013。大統通軌立成：八十八日2.40093568八十九日2.40144161，得f88.909225=2.4013956842。九十三日2.40105261九十四日2.40135032，得f93.712025=2.401264587
        cM: .04669798, // 極值(11.11*84 -.0281*84^2-.000325*84^3)/100=5.423376。大統通軌立成f84=5.42934424
    },
    Shoushi2: { // 大統通軌的參數用消長
        Type: 11,
        isAcr: true,
    ...
    Datong: { // 大統通軌。A A1，B B1參數分別一模一樣，只是把Solar改成solar
        Type: 11,
        isAcr: true,
        ApplyYear: [[1368, 1683]],
        CloseOriginAd: 1281,
    ...
    Xinfa: { // 新法曆書
        ...
        SunAvgVd: .98564736583175, // 這是按照360/Solar算的。西曆假如.09857
        StarVy: 51 / 3600,
        Lunar: 29.530592, // 月離曆指「今新曆表所用率」
        MoonAvgVd: 13.1763951842297, // 13.1763952.根據Vm·Lunar=VS·Lunar+360得13.1763951842297
        Anoma: 27.55584749,
        MapoVd: .111412138, // 根據：MoonAvgVd-360/Anoma得.1120170515。廖育棟：V引=13.064983079，Vm=13.176395217
        Node: 27.21219674,
        NodeVd: .052954977556, // 根據NodeVd+MoonAvgVd=360/Node得.0529671739
        ChouConst: 14.68526, // 根據交食表戊辰首朔14日16時26分46秒
        SolsConst: 14.09377, // 根據恆年表戊辰年己卯日53分36秒39微
        ...
        MansionDayConst: 14.09377, // 宿應
        MansionConst: 71.35, // 1628
        // EquaMansionConst: 
        MansionRaw: [11, 4.283333333333],
        ...
        ZhengNum: 2,
        OriginMonNum: 0,
        SperiVy: .0125, // 最卑perihelion每歲平行 ((8+29/60+14/3600)-(5+59/60+59/3600))/199
        SperiVd: .00003422386687,
        SperiConst: 5.9998, // 根據日躔表最高衝5度59分59秒，交食表太陽經度15度21分21秒、引數9度21分22秒，兩者一樣
        ModernPo: [39.906, 114.532, 60]
    },
    Yongnian: { // 康熙永年曆法。日躔表：自曆元戊辰年後戊午起至辛丑年止。月離表：自曆元戊辰二百年後戊子起至己酉年止。月離三項平行參數與崇禎曆書無縫銜接
        Type: 13,
        ApplyYear: [[1680, 1726]],
        ...
        StarVy: 51 / 3600,
        Lunar: 29.530592,
        SunAvgVd: .98564736583175, // 360/Solar    
        MoonAvgVd: 13.1763951842297,
        // MoonAvgVd: 13.1763952, // 廖育棟。根據永年表，22+33/60+38/3600+20/216000-(9+23/60+3/3600+19/216000)=13.17639
        Anoma: 27.55584749,
        MapoVd: .111412138, // 廖育棟
        Node: 27.21219674,
        NodeVd: .052954977556, // 廖育棟
        ChouConst: 14.68526,
        SolsConst: 14.09377, // 根據戊午年軫辛丑，平行47分7秒19微，得37.21463
        ...
        ZhengNum: 2,
        OriginMonNum: 0,
        SperiVy: .01699066874, // 最卑perihelion每歲平行 ((17+59/60+34/3600)-(7+4/60+4/3600))/643
        SperiVd: .0000465189108,
    ...
    Jiazi: { // 曆象考成
        ...
        SunAvgVd: .98564736583175, // 這是按照360/Solar算的。書中數據每日平行3548.3305169秒=.98564736580556
        SunAvgVm: 29.10675120111111,// 太阳平行朔策一十万四千七百八十四秒三○四三二四
        SperiVy: .0169907, // 最卑perihelion每歲平行″1/60+1/3600+10/216000
        SperiVd: .000046519, // .167469秒=.00004651916667
        ...
        MapoVd: .11141041027, // =401.077477秒。// 精確：MoonAvgVd-360/Anoma=360/29.530593+360/365.2421875-360/27.554568 = .11141041019840436。月孛每日平行6分41秒4微38纖54忽57芒、.11141041017
        MorbVm: 25.8167357194444, // 太陰引數朔策92940.24859/3600。按(MoonAvgVd-MapoVd)*Lunar-360=25.81673571933722
        Node: 27.212233, // 交終        
        NodeVd: .05295555555, // 新數=每交退行/Node=5187.120402/3600/27.212233=.052949229794311比舊數少一微，今仍用舊數。正交平行3分10秒38微=、190.64秒=.05295555555556
    ...
    Guimao: { // 曆象考成後編
        ...
        StarVy: 51 / 3600, // 岁差51″
        Lunar: 29.53059053,
        SunAvgVd: .985646969351664, // 太陽每日平行
        SperiVy: .0174993, // 最卑perihelion每歲平行62.9975″                
        SperiVd: .0000479114778077, // .17248 / 3600=.00004791111111
        ...
        MapoVd: .11140839611111, // 401.070226 / 3600
        MapoConst: 241.26267592592593, // 太陰最高應8 * 30 + 1 + 15 / 60 + 45 / 3600 + 38 / 216000
        NodeVd: .052955175, // 190.63863秒
        ...
        MapoConst: 241.26267592592593, // 最高應8 * 30 + 1 + 15 / 60 + 45 / 3600 + 38 / 216000
        NodeConst: 172.96043055555556, // 正交應：冬至次日子正正交白经5 * 30 + 22 + 57 / 60 + 37 / 3600 + 33 / 216000
        ...
        MansionDayConst: 20.12254, // 宿應，單位日。癸卯天正平冬至距角宿值日子正初刻，乃軫宿值日丑正三刻十一分有奇。
