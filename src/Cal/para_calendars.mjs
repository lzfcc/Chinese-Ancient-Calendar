export default {
    ...
    ////////////////
    Xinfa: { // 新法曆書。「⚠️」表示暫且用甲子曆數據
        Type: 13,
        ApplyYear: [[1645, 1679]],
        CloseOriginAd: 1628, // 崇禎元年戊辰
        Solar: 365.24218864, // 日躔表恆年表說：新法定用平行歲實
        Lunar: 29.530692, // 月離曆指「今新曆表所用率」
        Precession: 51 / 3600,
        SunAvgVd: .98564736275533, // 這是按照360/Solar算的。西曆假如.09857
        SunAvgVm: 29.10684869013986, // 太阳平行朔策
        SperiVy: .01699074074074074, // 最卑perihelion每歲平行⚠️
        SperiVd: .00004651910793, // ⚠️
        SorbVm: 29.1053774625,// 太阳引数朔策⚠️
        // ChouConst: 26.3852666,
        SolsConst: 15.09377, // 待定⚠️根據恆年表戊辰年己卯日53分36秒39微
        MoonAvgVd: 13.1763947714, // ⚠️ // 精確：Vm·Lunar=VS·Lunar+360=13.17639477141213
        Anoma: 27.55584749,
        MapoVd: .11141041027, // ⚠️ // 精確：MoonAvgVd-360/Anoma=360/29.530593+360/365.2421875-360/27.554568 = .11141041019840436。月孛每日平行6分41秒4微38纖54忽57芒、.11141041017
        MorbVm: 25.8167357194, // 太陰引數朔策⚠️。按(MoonAvgVd-MapoVd)*Lunar-360=25.81673571933722        
        Node: 27.21219674,
        NodeVd: 0.05295555553333, // ⚠️
        // MoonConst: 38.68257407407407, // 太陰平行應一宮8度40分57秒16微=38.68257407407407
        // MapoConst: 94.831708333333, // 三宮四度49分54秒9微
        // NodeConst: 207.227166666667, // 正交應：6宮27度13分37秒48微
        // ChouSunConst: 26.34526388888889, // 首朔太陽平行應初宫二十六度二十分四十二秒五十七微
        // ChouSorbConst: 19.1742638888889, // 首朔太阳引数应初宫一十九度一十分二十七秒二十一微
        // ChouMorbConst: 288.57396296296296, // 首朔太阴引数应九宫一十八度三十四分二十六秒一十六微
        // ChouWhitelongiConst: 180.51534259259259, // 首朔太阴交周应六宫初度三十分五十五秒一十四微
        MoonNodeVmSum: 30.67056015944444, // 太陰交周朔策⚠️
        MoonNodeVdSum: 13.2293503267, // ⚠️
        BjLat: 39.9166666666667, // ⚠️
        Sobliq: 23.525, // ⚠️
        MoonLimitAvg: 14.9, // 平望可食⚠️
        MoonLimit: 12.28194444444444, // 實望可食12+16/60+55/3600        
        MansionDayConst: 27.656374926, // 宿應，單位日 ⚠️
        MansionConst: 71.35, // 1628
        // EquaMansionConst: 
        MansionRaw: [11, 4.283333333333],
        SunLimitYinAvg: 20.8666666667, // 平朔食限⚠️
        SunLimitYangAvg: 8.85, // ⚠️
        SunLimitYinAcr: 18.25, // 實朔食限 ⚠️
    ...
    Yongnian: { // 康熙永年表
        Type: 13,
        ApplyYear: [[1680, 1726]],
        CloseOriginAd: 1717, // 康熙五十六年丁酉。存疑
        Solar: 365.2421875, // 週歲
        // Precession: , // 岁差″
        SperiConst: 7.7435555556, // 考成卷四求兩心差葉45：永年表的最卑應似乎不對，「今以丁酉年逐日實測日躔度分，求得最高過夏至⋯⋯各7°44′36″48''' 。」最大盈縮差2度3分9秒40微
        BjLat: 39.9166666666667, // 
        // Sobliq: , //
    },
    Jiazi: { // 曆象考成
        Type: 13,
        ...
        SperiVy: .01699074074074074, // 最卑perihelion每歲平行″1/60+1/3600+10/216000
        SperiVd: .00004651910793, // .167469秒=.00004651916667
        ...
        NodeConst: 207.227166666667, // 正交應：6宮27度13分37秒48微
        ChouSunConst: 26.34526388888889, // 首朔太陽平行應初宫二十六度二十分四十二秒五十七微
        ChouSorbConst: 19.1742638888889, // 首数太阳引数应初宫一十九度一十分二十七秒二十一微
        ChouMorbConst: 288.57396296296296, // 首朔太阴引数应九宫一十八度三十四分二十六秒一十六微
        ChouWhitelongiConst: 180.51534259259259, // 首朔太阴交周应六宫初度三十分五十五秒一十四微  
