export default {
    ...
    Jiazi: { // 曆象考成
        ...
        MoonAvgVd: 13.17639477141213, // Vm·Lunar=VS·Lunar+360=13.17639477141213。原術：47435.021177秒=13.17639477138889        
        Anoma: 27.554568, // 見卷五太陰平行度        
        MapoVd: .11141041019840436, // =MoonAvgVd-360/Anoma=360/29.530593+360/365.2421875-360/27.554568 = .11141041019840436。原書：月孛每日平行6分41秒4微38纖54忽57芒、.11141041017；401.077477秒=.11141041027778
        // 太陰引數朔策92940.24859/3600=25.81673571944444。按(MoonAvgVd-MapoVd)*Lunar-360=25.81673571933722
        Node: 27.212233, // 交終        
    ...
    Guimao: { // 曆象考成後編
        ...
        // MoonNodeMS: 110413.92441334 / 3600, // 太陰交周朔策（太阴交周在一个“朔策”里面运行的距离）。MoonPLUSNodeVd*Lunar-360=30.6705345506
