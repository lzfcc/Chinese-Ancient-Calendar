...
import { Ecliptic2Equator, Longi2Lati } from './Shangshu-calendar/bind_astronomy'
...
export default class Converter extends React.Component {
  ...
  handleLati() {
    try {
      const { Print } = Longi2Lati(this.state.Lati1, this.state.Lati4, this.state.Lati2, this.state.Lati3)
  ...
  render() {
    return (
      <section className='modulo'>
        ...
        <p className='note'>黃道去極度 = 週天/4 - 赤緯。<v>崇玄</v>、<v>崇天</v>、<v>明天</v>、<v>觀天</v>、<v>紀元</v>使用各自的週天度，不受輸入的週天度影響。<v>儀天</v>的自變量是距二至日數，而非實行度，所以結果與其他曆法有差異。日出時刻 = 夜半漏 + 2.5 刻<n>一日百刻。</n>球面三角的日出未計入蒙氣差、日視半徑等修正因素</p>
        {this.InputLati()}
