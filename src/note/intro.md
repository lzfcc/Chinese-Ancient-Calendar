...
16. **元** <n>1206—1370</n><u>郭守敬</u>等<v>授時</v><n>1281—1367</n>。早期授時是《授時曆議》中用的，閏應、轉應、交應略有區別。（李勇《授時曆與仲康日食推算》）
...
1. 修復麟德、崇天、紀元、授時交食，基本可用了
2. 時間模塊增加 decimal2stage
3. 重寫統天、授時歲實消長
4. 天文模塊增加歲實朔實消長
5. 增加早期授時，分為有無消長四種
6. 加上庚午里差
7. 精簡寫法：聲明變量放在一行；把所有 *= /= 過了一遍，應該沒問題
8. 修復四分沒有黃道度的小問題
