...
<v>皇極</v>一直到<v>宣明</v>，月亮改正都算了第二次修正。
...
月離表都是以日為單位，那月離應該用的是線性改正。但是日躔就不一樣了：

> 求經朔弦望入氣朏朒定數：各以所入氣小餘乘其日損益率，如樞法而一，即得。

這就是二次內插！

對於《皇極》二次公式，劉鈍（《皇極曆中等間距二次插值方法術文釋義及其物理意義》）、曲安京（《曆法》頁 240）有不同理解。原文「前少者⋯⋯乃別差加之」，別差是 `Δk^2 / n^2`，劉鈍改爲「半別差減之」，而「前多者，卽以總差加末率」，劉鈍補上「半別差減之」；曲安京則完全未改動原文，指出這是《皇極》的失誤之處。結合其他三種二次插值術（求月朔弦望應平會日所入遲速、推朔弦望定日術、求月入交去日道）來看，劉鈍校改之後的纔是術文原貌。

### 備忘

- 日躔二次內插算法的區別見曲安京《曆法》頁 241。崇天開始纔出現了精確的等間距二次內插，此前都是近似。經過手算，崇天算法與招差術完全一致，可以替代。
