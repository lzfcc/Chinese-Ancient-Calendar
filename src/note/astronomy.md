...
程序算得《重修大明》 1281 年前冬至己未在斗 0.366（小數點後取三位），分毫不差。
...
《授時曆經》只有晷漏立成，沒有躔離改正立成。太陽盈縮積度與《曆志》立成密合。太陰遲疾積度和立成總是差了一點點，比如 61 限，程序 4.9940，立成 4.99381075，87 限，程序 5.4283，立成 5.42827575，這點區別沒有影響。
...
以從舊之誼，<v>明天</v>還是沿用<v>大衍</v>的赤度表。直到北宋最後一部曆法<v>紀元</v>又做出調整。<v>紀元</v>觀測精度達到 0.25 度，《授時》達到 0.05 度。如果單從數字改變幅度來看的話，影響最深的是<v>太初</v>和<v>紀元</v>的赤度表。
...
藤豔輝<v>紀元曆日食算法及精度分析</v>距離冬至 31.816049 日，紀元日出 2126.2566/7290 = 29.1667572，我之前是直接用黃經，是 29.227518，差了 1 天多，改用距冬至日數，加上日躔，29.1664，密合。所以其他計算也應該要加上日躔。
...
- 授時：大都39.9500<n>現代</n>40.95<n>曆測四十度太強</n>
...
《元史授時曆經》、《明史曆志》都有晨昏立成，《曆經》是大都晷刻，《曆志》照錄《大統通軌》，用應天府晷刻。《大統》的自變量是積日，《曆經》是黃道積度，要注意區分。

自己根據晨昏立成試出來大統的半弧背，跟立成密合，太完美了。
...
另外，《授時曆經》、《大統曆志》定用分的分母「如定限行度而一」，正常理解的話就是月實速，但《大統通軌》、《大統曆志》在羅列日食用數時這樣解釋「定限行度」：「視同定限下遲疾行度⋯⋯全分內減去日行分八分二十秒，餘爲定限行度也。」「以定限，取立成內行度⋯⋯內減日行分八分二十秒」也就是說還要減去日平行速。而躔離改正不用減日平行，《大統曆志》步月離的分母：「以所入遲疾限下行度而一」。《授時曆經》沒有說，但可能是和《大統》一樣的處理方式。我聽說有種很普遍的說法是《大統》的躔離改正分母要減去日平行速，這是比《授時》進步的地方，這應該是一種誤解，卽使要減，也是在求定用分的時候，而不是躔離改正的時候。
...
| 1119四月丙子   |                | 6.34   | **7.14** |          |               |           | 18.8275 | 7838=18.8112 |          |                     |                     |
...
除了三個不太相合的，<v>紀元</v>基本上沒問題。應該是特殊情況的處理沒對，留待以後考慮，也不一定，萬一是藤豔輝錯了呢是吧。
...
10 沒說按照哪部曆法算出來八分，如果按照我的結果，就是<v>開禧</v>，按照藤的結果，是<v>統天</v>。如果單看這一條，我的程序應該比藤準確。統天差得有點多，估計是歲實消長算法不一樣。我紀元的月食時差似乎有點問題。
...
| --------- | -------- | ---------- | -------- | ---------- | -------- | ----------------------- | ----------------------- |
| 1292 正月 |          | 7.168      | 9.46    | 5481.8     | 5477     | 7.80 | 5907 |
| 1299 八月 | 二分有奇 | 2.67       | 2.68   | 4390       | 4389     | 3.29 | 4858 |
| 1302 六月 | 五十七秒 | 1.15       | 0.35   | 8058       | 8062     | 0.48 | 8132 |
...
1450 年正月月食分 11.55  虧 2952=辰初初刻。

> 正德九年八月辛卯日食，曆官報食八分六十七秒⋯⋯

1514 年八月辛卯朔，分 9.01 甚 5094，差了 0.34 分。有可能是回回曆推的？

> <n>嘉靖</n>七年，欽天監奏：閏十月朔，回回曆推日食二分四十七秒，大統曆推不食。

1528 年閏十月己巳朔，分 2.04 虧 4172 甚 4523。問題可能在於我沒有判斷是否入食限，所有的都情況直接進入程序算食分。

> 萬曆十二年十一月癸酉朔，大統曆推日食九十二秒，回回曆推不食。⋯⋯邇年月食在酉而曰戌，月食將旣而曰未九分

1584 年十一月癸酉朔，分 0.92 甚 5035，程序密合。

> <n>丙申</n>閏八月朔，日食，大統推初虧巳正二刻，食幾既，而臣候初虧巳正一刻，食止七分餘。大統實後天幾二刻⋯⋯

1596 年閏八月乙丑朔，分 9.89 虧 4531=巳正三刻。食分密合，初虧晚了一刻。

> <n>萬曆</n>二十五年五月甲戌夜月食，監官推算差一日。

> <n>崇禎</n>五年九月十五日月食，監推初虧在卯初一刻，光啓等推在卯初三刻，回回科推在辰初初刻。

1632 年九月己酉望月食，程序大統分 5.01 虧 2224=卯初一刻

> <n>崇禎</n>十年正月辛丑朔日食⋯⋯大統推食一分六十三秒⋯⋯

1637 年正月辛丑朔，程序大統分 3.70。可能是「三分」之訛。

以下是 1442 年朝鮮《交食通軌》所附《授時曆各年交食》，是《大統通軌》算法的交食細草，共八次月食一次日食，是僅存的古曆細草，我節選部分參數。
...
渾天說認爲天是一個球，地就不知道是什麼了，渾天說一直這是古曆的天文模型。姜岌<v>三紀甲子元曆</v>已知以月食所沖檢日之所在，這是明明白白的渾儀模型。可參考 [为什么 作为单个个体的某个古人 很早就知道 地球是球体？ - 桃李不言下自成蹊的回答](https://www.zhihu.com/question/263959552/answer/277638716)
