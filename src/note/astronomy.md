...
《授時》編製曆書時用立成表來線性內插，立成是用三次內插函數編製的，一近點月分 336 限，所以可以用線性來代替三次內插。程序直接用公式計算，方便快捷，省去錄入立成之苦。《授時》月離立成大槩受到五代王樸《欽天》啓發，《欽天》月行離爲 248 限，直接用立成取代了以往的每日月離表，用線性內差，省去計算之煩。可惜《欽天》躔離表沒有流傳下來。
