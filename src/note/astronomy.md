...
0. 隋代以前：漢代以前只能根據交食週期判斷是否可能出現日月食。魏晉時期，可以計算食分多少，判斷交食程度。
1. 大業、戊寅、皇極、麟德：出現時差、食差改正，但相當瑣碎不成熟，複雜無比。
2. 大衍、五紀、正元：規範化。
3. 宣明：日食三差公式算法確立下來，奠定後世步交會基本模式。此後崇玄、欽天、應天、乾元、儀天都在不斷調整，變動幅度也不小。
4. 崇天以後：成熟定型，此後各曆只有比較小的區別。紀元標誌著完全成熟。這一階段比以往都要簡明精練。
