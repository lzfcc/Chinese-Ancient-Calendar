...
2-03 修復2.16帶來的小bug，不提供Type===1曆法的詳細信息。
...
- 修復：重算了DE历表的朔，之前的迭代代码有误造成重复。
- 修復：置閏用進朔了之後的。
- 修復：清代曆法首朔舉冬至ChouSmd有問題，有可能平冬至在丑月，定冬至在子月，就會使ChouSmd變成寅月，如历象考成677、639、582BC等正月閏月沒了。增加了一個判斷條件，但感覺還不太好，以後看到錯了再說。目前核對了680–580BC沒問題。
- 修復：打印文件的Term命名上次沒改。
...
- 修復：根據施彥士的春秋日食，修復授時曆日食的食差符號問題。其他曆法尚待確認。

11-27

- 修復：Type2、3節氣干支少一日的問題，感謝 @玄厲白沙 指出。

### 2026

7-31 修復：Eclpise3中第二次判斷陰陽曆，用的是TheNodeAccum，這是換成了度數的，所以判斷條件應該用NodeCycle50。
